...
const About = () => {
  return (
    <div className="max-w-7xl mx-auto relative z-0">
      <motion.div variants={textVariant()} animate="visible" className="text-center">
      ...
      >
        ...
        <motion.blockquote
  variants={fadeIn("", "", 0.1, 1)}
  className="mt-10 text-black text-[24px] max-w-3xl leading-[36px] xl:ml-40 sm:ml-0 italic font-semibold border-l-4 border-[#915EFF] pl-4"
>
